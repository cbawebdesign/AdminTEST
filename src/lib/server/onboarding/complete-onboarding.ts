 ...
 */
export async function completeOnboarding({ userId, organizationName,organizationemail, organizationlastName, organizationcontactnumber, organizationdependants, organizationspouse }: Params) {
